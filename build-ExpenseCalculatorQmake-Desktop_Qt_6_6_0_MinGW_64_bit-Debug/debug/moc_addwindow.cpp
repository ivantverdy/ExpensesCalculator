...
Q_CONSTINIT static const qt_meta_stringdata_CLASSaddWindowENDCLASS_t qt_meta_stringdata_CLASSaddWindowENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 14),  // "refreshClicked"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 9),  // "saveClick"
        QT_MOC_LITERAL(36, 11)   // "cancelClick"
    },
    "addWindow",
    "refreshClicked",
    "",
...
void addWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &addWindow::refreshClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
