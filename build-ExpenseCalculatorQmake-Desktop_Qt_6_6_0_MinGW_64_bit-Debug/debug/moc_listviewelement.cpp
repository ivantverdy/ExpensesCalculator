/****************************************************************************
** Meta object code from reading C++ file 'listviewelement.h'
**
...
#include "../../ExpenseCalculatorQmake/listviewelement.h"
...
#error "The header file 'listviewelement.h' doesn't include <QObject>."
...
void listViewElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (listViewElement::*)();
            if (_t _q_method = &listViewElement::refreshClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void listViewElement::refreshClicked()
{
